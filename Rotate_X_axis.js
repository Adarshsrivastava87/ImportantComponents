...
class AppRotateX extends Component {
    render() {
        return (
            <View style={styles.container}>
                ...
                <View style={styles.squareContainer}>
                    <Square label='0' />
                    <Square label={rotationIncrement + 'deg'}
                        style={{ transform: [{ rotateX: rotationIncrement + 'deg' }] }} />

                    <Square label={2 * rotationIncrement + 'deg'}
                        style={{ transform: [{ rotateX: 2 * rotationIncrement + 'deg' }] }} />

                    <Square label={3 * rotationIncrement + 'deg'}
                        style={{ transform: [{ rotateX: 3 * rotationIncrement + 'deg' }] }} />

                    <Square label={4 * rotationIncrement + 'deg'}
